...
python -u ${MAIN_PATH}/run.py test/mnist mnist '{"p": 0.01, "T": 5, "learning_rate": 0.001, "batch_size": 50, "num_centroids": 4, "model_training_epoch": 30, "early_stopping_threshold": 10000000, "random_seed": 0, "class_balanced": true, "execute_early_stopping": false, "train_full_only": true, "model_PATH": "ideal_models", "use_memory_sets": false}'
