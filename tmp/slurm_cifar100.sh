...
#SBATCH -o test_cifar100/cifar100/out_%j.txt # File to which STDOUT will be written
#SBATCH -e test_cifar100/cifar100/err_%j.txt # File to which STDERR will be written
