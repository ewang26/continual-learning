...
OUTPUT_DIR = 'random_new_architecture_low_threshold'
...
QUEUE = [
    ('mnist', dict(
        ...
        T=[5],
        learning_rate=[0.001, 1000000], # consider [0.01, 0.005, 0.001]
        batch_size=[50], # consider [10, 30, 50, 65]
        num_centroids=[4], 
        model_training_epoch=[30], # consider [10, 20, 50]
        early_stopping_threshold=[0.001], # consider [0.1, 0.5, 1., 5., 10.]
        random_seed=range(5),
        class_balanced=[True],
        max_data_size=[6000],
        ),
